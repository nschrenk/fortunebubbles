...
class Data {
    ...
    static public var drop_words : Map<Color, Array<String>> = [
		...
		Yellow => ["honored", "happiness", "cheerful", "enegetic",
    ...
    static public var fortunes : Map<Int, Fortune> = [
		...
		19 => { title : "crafty thief",
			   fortune: "an understanding heart warms all that are graced with it's presense" },
		...
		39 => { title : "sad plum",
			   fortune: "our perception and attitude toward any situation will determine the outcome" },
		40 => { title : "royal pimp",
